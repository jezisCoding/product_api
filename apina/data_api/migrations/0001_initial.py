# Generated by Django 4.1.5 on 2024-10-30 14:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.PositiveSmallIntegerField(primary_key=True, serialize=False)),
                ('nazev', models.CharField(max_length=63)),
                ('obrazek', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_api.image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.PositiveSmallIntegerField(primary_key=True, serialize=False)),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_api.attribute')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_api.product')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_api.attributevalue'),
        ),
        migrations.AddField(
            model_name='attribute',
            name='nazev_atributu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_api.attributename'),
        ),
    ]
